// ==UserScript==
// @name         Overleaf Horizon Theme
// @namespace    http://tampermonkey.net/
// @version      2024-12-20
// @description  Horizon color scheme for Overleaf
// @author       pbaekgaard
...
:root {
  /* Base colors */
  --bg-color: #1c1e26 !important; /* Base - Horizon background */
  ...
  /* Cursor */
  --cursorColor: #6c6f93 !important; /* Horizon cursor color */
  --cursorInsertModeColor: #e95678 !important;

  /* Text */
  --textColor: #d5d8da !important; /* Foreground - Horizon text */
  --textColorSubtle: #666666; /* Comments - gray */
  --editorTextColor: var(--textColor); /* Editor text */

  /* Changed lines / Highlights */
  --lineChanged: #6c6f93; /* Horizon selection background */
  ...
  --tok-literal: #ee64ac; /* Constants / numbers - magenta */
...
/* Horizon - Syntax highlighting */

.tok-typeName {
  color: var(--tok-typeName) !important; /* Green - Functions */
  font-style: italic;
}
...
.tok-keyword {
  color: var(--tok-keyword) !important; /* Pink - Keywords */
  font-weight: 600;
}

.tok-attributeValue {
  color: var(--tok-attributeValue) !important; /* Orange - Strings */
}

.tok-literal {
  color: var(--tok-literal) !important; /* Magenta - Numbers */
}
